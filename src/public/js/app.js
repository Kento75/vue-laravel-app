...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setAspectRatio: function setAspectRatio() {
      ...
      var width = this.$refs.image.clientWidth; // 縦横比率3:4よりも横長の画像

      this.landscape = height / width <= 0.75; //　縦長でない場合
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onFileChange: function onFileChange(event) {
      ...
      var reader = new FileReader(); // ファイル読み込み後処理
        ...
        [
          ...
          _c("div", { staticClass: "photo-detail__pane" }, [
            ...
            _vm.photo.comments.length > 0
              ? _c(
                  "ul",
                  { staticClass: "photo_detail__comments" },
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Ajaxリクエストであることを示すヘッダーを付与
...
var UNPROCESSABLE_ENTITY = 422; // バリデーションエラー(Laravel)
